...
| **Status** | Open — parity pins now **skip** violet_visitor via `EXPERIMENT_IN_PROGRESS` (2026-08-03); re-pin when the roster lands (Epic #242 S3 #246) |
