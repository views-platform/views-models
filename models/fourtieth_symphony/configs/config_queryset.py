...
def generate():
    ...
    queryset = (Queryset('uncertainty_conflict_2_nolog','country_month')
        ...
        .with_column(Column('ged_sb_onset_possible', from_loa='country_month', from_column='ged_sb_best_sum_nokgi')
            .transform.missing.replace_na()
            .transform.temporal.onset_possible(36)
            .transform.missing.replace_na()
            )
        
        .with_column(Column('ged_sb_deep_mean', from_loa='country_month', from_column='ged_sb_best_sum_nokgi')
            .transform.missing.replace_na()
            .transform.temporal.moving_average(240)
            .transform.missing.replace_na()
            )
        
        .with_column(Column('ged_sb_moving_average_36', from_loa='country_month', from_column='ged_sb_best_sum_nokgi')
            .transform.missing.replace_na()
