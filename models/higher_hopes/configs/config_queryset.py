...
def generate():
    ...
    .with_column(Column('ln_ged_ns_tlag_3', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
        .transform.ops.ln()
        .transform.missing.fill()
        .transform.temporal.tlag(3)
        .transform.missing.fill()
    ...
    .with_column(Column('ln_ged_ns_tlag_4', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
        .transform.ops.ln()
        .transform.missing.fill()
        .transform.temporal.tlag(4)
        .transform.missing.fill()
    ...
    .with_column(Column('ln_ged_ns_tlag_5', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
        .transform.ops.ln()
        .transform.missing.fill()
        .transform.temporal.tlag(5)
        .transform.missing.fill()
    ...
    .with_column(Column('ln_ged_ns_tlag_6', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
        .transform.ops.ln()
        .transform.missing.fill()
        .transform.temporal.tlag(6)
        .transform.missing.fill()
    ...
    .with_column(Column('ln_ged_ns_tsum_24', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
        .transform.missing.replace_na()
        .transform.temporal.moving_sum(24)
        .transform.ops.ln()
        .transform.missing.replace_na()
    ...
    .with_column(Column('ln_ged_os_tsum_24', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
        .transform.missing.replace_na()
        .transform.temporal.moving_sum(24)
        .transform.ops.ln()
        .transform.missing.replace_na()
    ...
    .with_column(Column('ln_ged_os_tlag_3', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
        .transform.ops.ln()
        .transform.missing.fill()
        .transform.temporal.tlag(3)
        .transform.missing.fill()
    ...
    .with_column(Column('ln_ged_os_tlag_4', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
        .transform.ops.ln()
        .transform.missing.fill()
        .transform.temporal.tlag(4)
        .transform.missing.fill()
    ...
    .with_column(Column('ln_ged_os_tlag_5', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
        .transform.ops.ln()
        .transform.missing.fill()
        .transform.temporal.tlag(5)
        .transform.missing.fill()
    ...
    .with_column(Column('ln_ged_os_tlag_6', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
        .transform.ops.ln()
        .transform.missing.fill()
        .transform.temporal.tlag(6)
        .transform.missing.fill()
