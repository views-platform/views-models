...
def generate():
    ...
    queryset_base = (Queryset(f"{model_name}", "priogrid_month")
        .with_column(Column("lr_ged_sb", from_loa = "priogrid_month", from_column = "ged_sb_best_sum_nokgi").transform.missing.replace_na())
        .with_column(Column("lr_ged_ns", from_loa = "priogrid_month", from_column = "ged_ns_best_sum_nokgi").transform.missing.replace_na())
        .with_column(Column("lr_ged_os", from_loa = "priogrid_month", from_column = "ged_os_best_sum_nokgi").transform.missing.replace_na())
