def get_sweep_config():
    """
    Harmonized sweep configuration for party_princess (BlockRNN).
    ...
    parameters = {
        ...
        'lr': {'values': [0.0002478189178930891]},
        ...
        # --- BlockRNN Specific Architecture (Focused Search) ---
        'rnn_type': {'values': ['GRU']},
        'hidden_dim': {'values': [256]},
        'n_rnn_layers': {'values': [2]},
        'dropout': {'values': [0.2]},
