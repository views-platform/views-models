...
def generate():
    ...
    queryset = (Queryset(f'{model_name}','country_month')
        ...
        .with_column(Column('ln_ged_ns_dep', from_loa='country_month', from_column='ged_sb_best_sum_nokgi')
            .transform.ops.ln()
            .transform.missing.fill()
            .transform.missing.replace_na()
            )
        .with_column(Column('ln_ged_os_dep', from_loa='country_month', from_column='ged_sb_best_sum_nokgi')
            .transform.ops.ln()
            .transform.missing.fill()
            .transform.missing.replace_na()
            )
