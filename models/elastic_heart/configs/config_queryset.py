...
def generate():
    ...
    def _add_conflict_history(queryset: Queryset) -> Queryset:
        ...
        return (
            ...
            .with_column(Column('lr_acled_ns', from_loa='country_month', from_column='acled_ns_fat')
            # .transform.ops.ln()
            .transform.missing.fill()
            .transform.missing.replace_na()
            )
    ...
    def _add_temporal_lags(queryset: Queryset) -> Queryset:
        ...
        return (
            ...
            .with_column(Column('lr_ged_ns_tlag_1', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
                .transform.missing.fill()
                .transform.temporal.tlag(1)
                .transform.missing.fill()
                .transform.missing.replace_na()
            )
            .with_column(Column('lr_ged_ns_tlag_2', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
                .transform.missing.fill()
                .transform.temporal.tlag(2)
                .transform.missing.fill()
                .transform.missing.replace_na()
            )
            .with_column(Column('lr_ged_ns_tlag_3', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
                .transform.missing.fill()
                .transform.temporal.tlag(3)
                .transform.missing.fill()
                .transform.missing.replace_na()
            )
            .with_column(Column('lr_ged_ns_tlag_4', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
                .transform.missing.fill()
                .transform.temporal.tlag(4)
                .transform.missing.fill()
                .transform.missing.replace_na()
            )
            .with_column(Column('lr_ged_ns_tlag_5', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
                .transform.missing.fill()
                .transform.temporal.tlag(5)
                .transform.missing.fill()
                .transform.missing.replace_na()
            )
            .with_column(Column('lr_ged_ns_tlag_6', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
                .transform.missing.fill()
                .transform.temporal.tlag(6)
                .transform.missing.fill()
                .transform.missing.replace_na()
            )
            .with_column(Column('lr_ged_sb_tsum_24', from_loa='country_month', from_column='ged_sb_best_sum_nokgi')
                .transform.missing.replace_na()
                .transform.temporal.moving_sum(24)
                .transform.missing.replace_na()
            )
            .with_column(Column('lr_ged_ns_tsum_24', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
                .transform.missing.replace_na()
                .transform.temporal.moving_sum(24)
                .transform.missing.replace_na()
            )
            .with_column(Column('lr_ged_os_tsum_24', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
                .transform.missing.replace_na()
                .transform.temporal.moving_sum(24)
                .transform.missing.replace_na()
            )
            ...
            .with_column(Column('lr_ged_os_tlag_2', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
                .transform.missing.fill()
                .transform.temporal.tlag(2)
                .transform.missing.fill()
                .transform.missing.replace_na()
            )
            .with_column(Column('lr_ged_os_tlag_3', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
                .transform.missing.fill()
                .transform.temporal.tlag(3)
                .transform.missing.fill()
                .transform.missing.replace_na()
            )
            .with_column(Column('lr_ged_os_tlag_4', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
                .transform.missing.fill()
                .transform.temporal.tlag(4)
                .transform.missing.fill()
                .transform.missing.replace_na()
            )
            .with_column(Column('lr_ged_os_tlag_5', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
                .transform.missing.fill()
                .transform.temporal.tlag(5)
                .transform.missing.fill()
                .transform.missing.replace_na()
            )
            .with_column(Column('lr_ged_os_tlag_6', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
                .transform.missing.fill()
                .transform.temporal.tlag(6)
                .transform.missing.fill()
                .transform.missing.replace_na()
