def get_sweep_config():
    ...
    parameters = {
        ...
        # TSMixer specific architecture
        'num_blocks': {'values': [2, 3, 4]},  # Number of mixer blocks
        'ff_size': {'values': [32, 64, 128]},  # Size of feedforward layers
        'hidden_size': {'values': [32, 64, 128]},  # Size of hidden layers
        'activation': {'values': ['ReLU', 'LeakyReLU', 'Tanh']},
        'dropout': {'values': [0.1, 0.2, 0.3]},
        'norm_type': {'values': ['LayerNorm', 'BatchNorm']},  # Type of normalization
        'normalize_before': {'values': [True, False]},  # Whether to normalize before or after mixing
