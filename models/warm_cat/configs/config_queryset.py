...
def generate():
    ...
    qs_sptime_dist = (
        ...
        .with_column(
            Column("lr_ttime_mean", from_loa="priogrid_year", from_column="ttime_mean")
            .transform.missing.fill()
            .transform.missing.replace_na()
        )
        .with_column(
            Column("lr_bdist3", from_loa="priogrid_year", from_column="bdist3")
            .transform.missing.fill()
            .transform.missing.replace_na()
        )
        .with_column(
            Column("lr_capdist", from_loa="priogrid_year", from_column="capdist")
            .transform.missing.fill()
            .transform.missing.replace_na()
        )
        .with_column(
            Column(
                "lr_pop_gpw_sum", from_loa="priogrid_year", from_column="pop_gpw_sum"
            )
            .transform.missing.fill()
            .transform.missing.replace_na()
        )
