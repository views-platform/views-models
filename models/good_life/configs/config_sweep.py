...
def get_sweep_config():
    ...
    parameters = {
        ...
        'd_model': {'values': [32, 64, 128]},  # Dimension of the input and output
        'nhead': {'values': [2, 4, 8]},  # Number of attention heads
        'num_encoder_layers': {'values': [2, 3, 4]},  # Number of encoder layers
        'num_decoder_layers': {'values': [2, 3, 4]},  # Number of decoder layers
        'dim_feedforward': {'values': [128, 256, 512]},  # Dimension of feedforward network
        'dropout': {'values': [0.1, 0.2, 0.3]},
        'activation': {'values': ['ReLU', 'LeakyReLU', 'Tanh']},
        'norm_type': {'values': [None, 'LayerNorm', 'BatchNorm']},  # Type of normalization
