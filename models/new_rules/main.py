...
if __name__ == "__main__":
    ...
    if args.sweep:
        DartsForecastingModelManager(model_path=model_path, wandb_notifications=False, use_prediction_store=False).execute_sweep_run(args)
    else:
        DartsForecastingModelManager(model_path=model_path, wandb_notifications=False, use_prediction_store=False).execute_single_run(args)
