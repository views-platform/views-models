...
def get_hp_config():
    ...
    hyperparameters = {
        ...
        'activation': 'ELU',
        'batch_size': 64,
        'delta': 0.30440277762580575,
        'dropout': 0.3,
        'early_stopping_patience': 6,
        'false_negative_weight': 17.321616366327728,
        'false_positive_weight': 17.922787096983832,
        'feature_scaler': 'MinMaxScaler',
        'generic_architecture': False,
        'gradient_clip_val': 1.259745868482342,
        'input_chunk_length': 72,
        'layer_widths': 256,
        'loss_function': 'WeightedPenaltyHuberLoss',
        'lr': 0.00005029063059802105,
        'n_epochs': 300,
        'non_zero_weight': 7.014117694630754,
        'num_blocks': 2,
        'num_stacks': 7,
        'target_scaler': None,
        'weight_decay': 0.00005355119486100957,
        'zero_threshold': 0.41899708658665513,
