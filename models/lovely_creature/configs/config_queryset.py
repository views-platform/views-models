...
def generate():
    ...
    queryset = (Queryset(f'{model_name}','country_month')
        ...
        .with_column(Column('ged_os_tlag_2', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
            .transform.missing.fill()
            .transform.temporal.tlag(2)
            .transform.missing.fill()
            .transform.missing.replace_na()
        ...
        .with_column(Column('ged_os_tlag_3', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
            .transform.missing.fill()
            .transform.temporal.tlag(3)
            .transform.missing.fill()
            .transform.missing.replace_na()
        ...
        .with_column(Column('ged_os_tlag_4', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
            .transform.missing.fill()
            .transform.temporal.tlag(4)
            .transform.missing.fill()
            .transform.missing.replace_na()
        ...
        .with_column(Column('ged_os_tlag_5', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
            .transform.missing.fill()
            .transform.temporal.tlag(5)
            .transform.missing.fill()
            .transform.missing.replace_na()
        ...
        .with_column(Column('ged_os_tlag_6', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
            .transform.missing.fill()
            .transform.temporal.tlag(6)
            .transform.missing.fill()
            .transform.missing.replace_na()
        ...
        .with_column(Column('ged_ns_tlag_1', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
            .transform.missing.fill()
            .transform.temporal.tlag(1)
            .transform.missing.fill()
            .transform.missing.replace_na()
        ...
        .with_column(Column('ged_ns_tlag_2', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
            .transform.missing.fill()
            .transform.temporal.tlag(2)
            .transform.missing.fill()
            .transform.missing.replace_na()
        ...
        .with_column(Column('ged_ns_tlag_3', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
            .transform.missing.fill()
            .transform.temporal.tlag(3)
            .transform.missing.fill()
            .transform.missing.replace_na()
        ...
        .with_column(Column('ged_ns_tlag_4', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
            .transform.missing.fill()
            .transform.temporal.tlag(4)
            .transform.missing.fill()
            .transform.missing.replace_na()
        ...
        .with_column(Column('ged_ns_tlag_5', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
            .transform.missing.fill()
            .transform.temporal.tlag(5)
            .transform.missing.fill()
            .transform.missing.replace_na()
        ...
        .with_column(Column('ged_ns_tlag_6', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
            .transform.missing.fill()
            .transform.temporal.tlag(6)
            .transform.missing.fill()
            .transform.missing.replace_na()
        ...
        .with_column(Column('decay_240_ged_os_100', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
            .transform.missing.replace_na()
            .transform.bool.gte(100)
            .transform.temporal.time_since()
            .transform.temporal.decay(240)
        ...
        .with_column(Column('decay_ged_os_1000', from_loa='country_month', from_column='ged_os_best_sum_nokgi')
            .transform.missing.replace_na()
            .transform.bool.gte(1000)
            .transform.temporal.time_since()
            .transform.temporal.decay(24)
        ...
        .with_column(Column('decay_240_ged_ns_100', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
            .transform.missing.replace_na()
            .transform.bool.gte(100)
            .transform.temporal.time_since()
            .transform.temporal.decay(240)
        ...
        .with_column(Column('decay_ged_ns_1000', from_loa='country_month', from_column='ged_ns_best_sum_nokgi')
            .transform.missing.replace_na()
            .transform.bool.gte(1000)
            .transform.temporal.time_since()
            .transform.temporal.decay(24)
