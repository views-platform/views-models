...
env_path="$project_path/envs/views-seldon"
...
if [ -d "$env_path" ]; then
  ...
  echo "Installing views-seldon from GitHub..."
  pip install git+https://${GITHUB_TOKEN}@github.com/views-platform/views-seldon.git@main
else
