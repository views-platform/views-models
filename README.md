...
| ---------- | --------- | ------- | -------------- | --------------------------- | ---------------- | --------------------- | ------------------- | ------ |
| adolecent_slob | TCNModel | lr_ged_sb_dep | None | - [hyperparameters adolecent_slob](https://github.com/views-platform/views-models/blob/main/models/adolecent_slob/configs/config_hyperparameters.py) | None | shadow | NA | Simon |
...
| bad_romance | TiDEModel | lr_ged_sb | None | - [hyperparameters bad_romance](https://github.com/views-platform/views-models/blob/main/models/bad_romance/configs/config_hyperparameters.py) | None | shadow | NA | Dylan |
...
| bouncy_organ | TSMixerModel | lr_ged_sb_dep | None | - [hyperparameters bouncy_organ](https://github.com/views-platform/views-models/blob/main/models/bouncy_organ/configs/config_hyperparameters.py) | None | shadow | NA | Simon |
...
| cold_heart | NBEATSModel | lr_ged_sb | None | - [hyperparameters cold_heart](https://github.com/views-platform/views-models/blob/main/models/cold_heart/configs/config_hyperparameters.py) | None | shadow | NA | Dylan |
...
| dancing_queen | BlockRNNModel | lr_ged_sb | None | - [hyperparameters dancing_queen](https://github.com/views-platform/views-models/blob/main/models/dancing_queen/configs/config_hyperparameters.py) | None | shadow | NA | Dylan |
...
| elastic_heart | TSMixerModel | lr_ged_sb | None | - [hyperparameters elastic_heart](https://github.com/views-platform/views-models/blob/main/models/elastic_heart/configs/config_hyperparameters.py) | None | shadow | NA | Dylan |
...
| emerging_principles | NBEATSModel | lr_ged_sb | None | - [hyperparameters emerging_principles](https://github.com/views-platform/views-models/blob/main/models/emerging_principles/configs/config_hyperparameters.py) | None | shadow | NA | Simon |
| fancy_feline | TiDEModel | lr_ged_sb_dep | None | - [hyperparameters fancy_feline](https://github.com/views-platform/views-models/blob/main/models/fancy_feline/configs/config_hyperparameters.py) | None | shadow | NA | Simon |
...
| free_fallin | TSMixerModel | lr_ged_sb | None | - [hyperparameters free_fallin](https://github.com/views-platform/views-models/blob/main/models/free_fallin/configs/config_hyperparameters.py) | None | shadow | NA | Dylan |
| good_life | TransformerModel | lr_ged_sb | None | - [hyperparameters good_life](https://github.com/views-platform/views-models/blob/main/models/good_life/configs/config_hyperparameters.py) | None | shadow | NA | Dylan |
...
| green_ranger | MixtureBaseline | lr_ns_best | None | - [hyperparameters green_ranger](https://github.com/views-platform/views-models/blob/main/models/green_ranger/configs/config_hyperparameters.py) | None | shadow | NA | Simon |
...
| heat_waves | TFTModel | lr_ged_sb | None | - [hyperparameters heat_waves](https://github.com/views-platform/views-models/blob/main/models/heat_waves/configs/config_hyperparameters.py) | None | shadow | NA | Dylan |
...
| hot_stream | TFTModel | lr_ged_sb_dep | None | - [hyperparameters hot_stream](https://github.com/views-platform/views-models/blob/main/models/hot_stream/configs/config_hyperparameters.py) | None | shadow | NA | Simon |
...
| new_rules | NBEATSModel | lr_ged_sb | None | - [hyperparameters new_rules](https://github.com/views-platform/views-models/blob/main/models/new_rules/configs/config_hyperparameters.py) | None | shadow | NA | Dylan |
| novel_heuristics | NBEATSModel | lr_ged_sb | None | - [hyperparameters novel_heuristics](https://github.com/views-platform/views-models/blob/main/models/novel_heuristics/configs/config_hyperparameters.py) | None | shadow | NA | Simon |
...
| party_princess | BlockRNNModel | lr_ged_sb_dep | None | - [hyperparameters party_princess](https://github.com/views-platform/views-models/blob/main/models/party_princess/configs/config_hyperparameters.py) | None | shadow | NA | Simon |
...
| preliminary_directives | NBEATSModel | lr_ged_sb | None | - [hyperparameters preliminary_directives](https://github.com/views-platform/views-models/blob/main/models/preliminary_directives/configs/config_hyperparameters.py) | None | shadow | NA | Simon |
...
| red_ranger | MixtureBaseline | lr_ged_sb | None | - [hyperparameters red_ranger](https://github.com/views-platform/views-models/blob/main/models/red_ranger/configs/config_hyperparameters.py) | None | shadow | NA | Simon |
| revolving_door | NHiTSModel | lr_ged_sb | None | - [hyperparameters revolving_door](https://github.com/views-platform/views-models/blob/main/models/revolving_door/configs/config_hyperparameters.py) | None | shadow | NA | Dylan |
| shining_codex | NBEATSModel | lr_ged_sb | None | - [hyperparameters shining_codex](https://github.com/views-platform/views-models/blob/main/models/shining_codex/configs/config_hyperparameters.py) | None | shadow | NA | Simon |
| smol_cat | TiDEModel | lr_ged_sb | None | - [hyperparameters smol_cat](https://github.com/views-platform/views-models/blob/main/models/smol_cat/configs/config_hyperparameters.py) | None | shadow | NA | Dylan |
...
| yellow_ranger | MixtureBaseline | lr_os_best | None | - [hyperparameters yellow_ranger](https://github.com/views-platform/views-models/blob/main/models/yellow_ranger/configs/config_hyperparameters.py) | None | shadow | NA | Simon |
...
| black_ranger | MixtureBaseline | lr_os_best | None | - [hyperparameters black_ranger](https://github.com/views-platform/views-models/blob/main/models/black_ranger/configs/config_hyperparameters.py) | None | shadow | NA | Simon |
...
| blue_ranger | MixtureBaseline | lr_ged_sb | None | - [hyperparameters blue_ranger](https://github.com/views-platform/views-models/blob/main/models/blue_ranger/configs/config_hyperparameters.py) | None | shadow | NA | Simon |
...
| diagonal_dream | LocfModel | synth_target | None | - [hyperparameters diagonal_dream](https://github.com/views-platform/views-models/blob/main/models/diagonal_dream/configs/config_hyperparameters.py) | None | shadow | NA | synthetic_test |
...
| horizontal_dream | LocfModel | synth_target | None | - [hyperparameters horizontal_dream](https://github.com/views-platform/views-models/blob/main/models/horizontal_dream/configs/config_hyperparameters.py) | None | shadow | NA | synthetic_test |
...
| lucid_dream | ConflictologyModel | synth_target | None | - [hyperparameters lucid_dream](https://github.com/views-platform/views-models/blob/main/models/lucid_dream/configs/config_hyperparameters.py) | None | shadow | NA | synthetic_test |
...
| pink_ranger | MixtureBaseline | lr_ns_best | None | - [hyperparameters pink_ranger](https://github.com/views-platform/views-models/blob/main/models/pink_ranger/configs/config_hyperparameters.py) | None | shadow | NA | Simon |
...
| vertical_dream | LocfModel | synth_target | None | - [hyperparameters vertical_dream](https://github.com/views-platform/views-models/blob/main/models/vertical_dream/configs/config_hyperparameters.py) | None | shadow | NA | synthetic_test |
...
| vivid_dream | MixtureBaseline | synth_target | None | - [hyperparameters vivid_dream](https://github.com/views-platform/views-models/blob/main/models/vivid_dream/configs/config_hyperparameters.py) | None | shadow | NA | synthetic_test |
| waking_dream | MixtureBaseline | synth_target | None | - [hyperparameters waking_dream](https://github.com/views-platform/views-models/blob/main/models/waking_dream/configs/config_hyperparameters.py) | None | shadow | NA | synthetic_test |
